...
public final class RqdClientGrpc implements RqdClient {
     ...
     * lost (or never produced in time). Every other code is an actual response generated by the
     * server's application layer (RQD rejects launches with ABORTED, FAILED_PRECONDITION or
     * INVALID_ARGUMENT; an unhandled server-side error surfaces as UNKNOWN), which proves the
     * launch was processed and rejected.
     */
